...
| 分类 | 注解 | 说明 |
|------|------|------|
| **基础** | [@Alpha](#alpha) | 纯英文字母验证 |
| **基础** | [@AlphaDash](#alphadash) | 字母数字下划线横线组合 |
| **基础** | [@AlphaNumber](#alphanumber) | 字母数字组合验证 |
| **基础** | [@Chinese](#chinese) | 纯中文字符验证 |
| **基础** | [@ChineseAlpha](#chinesealpha) | 中文字符和字母组合 |
| **基础** | [@ChineseAlphaNum](#chinesealphanum) | 中文字符、字母和数字组合 |
| **基础** | [@ChineseAlphaDash](#chinesealphadash) | 中文、字母、数字、下划线、横线组合 |
| **基础** | [@Lower](#lower) | 小写字符验证 |
| **基础** | [@Upper](#upper) | 大写字符验证 |
| **基础** | [@Xdigit](#xdigit) | 十六进制字符串验证 |
| **地理** | [@Longitude](#longitude) | 经度验证（-180到180） |
| **地理** | [@Latitude](#latitude) | 纬度验证（-90到90） |
| **地理** | [@GeoPoint](#geopoint) | 地理坐标对验证 |
| **日期时间** | [@FutureDate](#futuredate) | 未来日期验证 |
| **日期时间** | [@PastDate](#pastdate) | 过去日期验证 |
| **日期时间** | [@HourMinute](#hourminute) | 时分格式（HH:mm） |
| **日期时间** | [@HourMinuteSecond](#hourminutesecond) | 时分秒格式（HH:mm:ss） |
| **日期时间** | [@Timestamp](#timestamp) | Unix时间戳验证 |
| **日期时间** | [@CronExpression](#cronexpression) | Cron表达式验证 |
| **日期时间** | [@Duration](#duration) | 时间段格式验证 |
| **物流** | [@ExpressNumber](#expressnumber) | 快递单号验证 |
| **字符串** | [@StartsWith](#startswith) | 字符串前缀验证 |
| **字符串** | [@EndsWith](#endswith) | 字符串后缀验证 |
| **字符串** | [@In](#in) | 值必须在指定列表中 |
| **字符串** | [@NotIn](#notin) | 值不能在指定列表中 |
| **字符串** | [@Enum](#enum) | 枚举值验证 |
| **字符串** | [@Color](#color) | 颜色格式（HEX/RGB/RGBA） |
| **字符串** | [@Password](#password) | 密码强度验证 |
| **字符串** | [@UUID](#uuid) | UUID格式验证 |
| **字符串** | [@Base64](#base64) | Base64编码验证 |
| **字符串** | [@JSON](#json) | JSON格式验证 |
| **字符串** | [@JWT](#jwt) | JWT令牌格式验证 |
| **字符串** | [@SemVer](#semver) | 语义化版本验证 |
| **文件** | [@FileExtension](#fileextension) | 文件扩展名验证 |
| **文件** | [@FileSize](#filesize) | 文件大小范围验证 |
| **数值** | [@Age](#age) | 年龄验证（从出生日期或身份证） |
| **数值** | [@Port](#port) | 端口号验证（0-65535） |
| **身份** | [@ChineseIdCard](#chineseidcard) | 中国身份证验证 |
| **身份** | [@ChinesePassport](#chinesepassport) | 中国护照验证 |
| **身份** | [@ChineseMilitaryOfficer](#chinesemilitaryofficer) | 军官证验证 |
| **身份** | [@ChineseSoldier](#chinesesoldier) | 士兵证验证 |
| **身份** | [@ForeignerPermanentResidenceIdentity](#foreignerpermanentresidenceidentity) | 外国人永久居留身份证 |
| **身份** | [@HKMacauResidence](#hkmacauresidence) | 港澳居民居住证 |
| **身份** | [@HKMacauPass](#hkmacaupass) | 港澳居民来往内地通行证 |
| **身份** | [@TaiwanResidence](#taiwanresidence) | 台湾居民居住证 |
| **身份** | [@TaiwanPass](#taiwanpass) | 台湾居民来往大陆通行证 |
| **身份** | [@ForeignerWorkPermit](#foreignerworkpermit) | 外国人工作许可证 |
| **身份** | [@UnifiedSocialCreditCode](#unifiedsocialcreditcode) | 统一社会信用代码 |
| **联系** | [@ChinesePhone](#chinesephone) | 中国手机号验证 |
| **联系** | [@ChineseLandline](#chineselandline) | 中国座机号验证 |
| **联系** | [@ChinesePhoneOrLandline](#chinesephoneorlandline) | 中国手机号或座机号 |
| **联系** | [@PhoneNumber](#phonenumber) | 国际电话号码验证 |
| **联系** | [@Email](#email) | 电子邮箱验证 |
| **联系** | [@QQ](#qq) | QQ号验证 |
| **联系** | [@WeChat](#wechat) | 微信号验证 |
| **金融** | [@BankCard](#bankcard) | 银行卡号验证（Luhn算法） |
| **金融** | [@CVV](#cvv) | CVV/CVC安全码验证 |
| **金融** | [@IBAN](#iban) | IBAN账号验证 |
| **金融** | [@SWIFT](#swift) | SWIFT/BIC代码验证 |
| **金融** | [@StockCode](#stockcode) | 股票代码验证 |
| **金融** | [@TradeOrderNumber](#tradeordernumber) | 交易订单号验证 |
| **金融** | [@FinancialProductCode](#financialproductcode) | 金融产品代码验证 |
| **教育** | [@DegreeCertificate](#degreecertificate) | 学位证书编号 |
| **教育** | [@Doctor](#doctor) | 医师资格证书 |
| **教育** | [@Teacher](#teacher) | 教师资格证书 |
| **教育** | [@Lawyer](#lawyer) | 法律职业资格证书 |
| **教育** | [@PMP](#pmp) | PMP证书验证 |
| **教育** | [@Constructor](#constructor) | 建造师证书 |
| **教育** | [@Accountant](#accountant) | 会计资格证书 |
| **网络** | [@Domain](#domain) | 域名验证 |
| **网络** | [@Ip](#ip) | IP地址验证（IPv4/IPv6） |
| **网络** | [@Mac](#mac) | MAC地址验证 |
| **网络** | [@Url](#url) | URL地址验证 |
| **网络** | [@SubnetMask](#subnetmask) | 子网掩码验证 |
| **中国** | [@ChineseLicensePlate](#chineselicenseplate) | 中国车牌号验证 |
| **中国** | [@ChinesePatent](#chinesepatent) | 中国专利号验证 |
| **中国** | [@ChineseTrademark](#chinesetrademark) | 中国商标注册号 |
| **中国** | [@SoftwareCopyright](#softwarecopyright) | 软件著作权登记号 |
| **中国** | [@WorkCopyright](#workcopyright) | 一般作品著作权登记号 |
| **中国** | [@ChineseZipCode](#chinesezipcode) | 中国邮政编码验证 |
| **医药** | [@DrugApproval](#drugapproval) | 药品批准文号验证 |
| **医药** | [@DrugCode](#drugcode) | 药品本位码验证 |
| **医药** | [@MedicalDeviceRegistration](#medicaldeviceregistration) | 医疗器械注册证号 |
| **汽车** | [@VIN](#vin) | 车辆识别代码 |
| **汽车** | [@VehicleEngine](#vehicleengine) | 车辆发动机号验证 |
| **出版** | [@ISBN](#isbn) | ISBN书号验证 |
| **出版** | [@ISSN](#issn) | ISSN期刊号验证 |
| **出版** | [@DOI](#doi) | DOI标识符验证 |
| **出版** | [@CLC](#clc) | 中图分类号 |
| **出版** | [@DDC](#ddc) | 杜威十进分类法 |
| **出版** | [@ORCID](#orcid) | ORCID研究者ID验证 |
| **出版** | [@IPC](#ipc) | 国际专利分类号 |
| **设备** | [@IMEI](#imei) | IMEI设备号验证 |
