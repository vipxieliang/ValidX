...
@Documented
@Constraint(validatedBy = DegreeCertificateValidator.class)
public @interface DegreeCertificate {
    String message() default "{io.github.vipxieliang.validx.annotation.degree.certificate}";
