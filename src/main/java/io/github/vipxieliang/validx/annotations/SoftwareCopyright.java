 ...
 */
@Documented
@Constraint(validatedBy = SoftwareCopyrightValidator.class)
@Target({ ElementType.METHOD, ElementType.FIELD })
@Retention(RetentionPolicy.RUNTIME)
public @interface SoftwareCopyright {
    String message() default "{io.github.vipxieliang.validx.annotation.software.copyright}";
