 ...
 */
@Documented
@Constraint(validatedBy = WorkCopyrightValidator.class)
@Target({ ElementType.METHOD, ElementType.FIELD })
@Retention(RetentionPolicy.RUNTIME)
public @interface WorkCopyright {
    String message() default "{io.github.vipxieliang.validx.annotation.work.copyright}";
