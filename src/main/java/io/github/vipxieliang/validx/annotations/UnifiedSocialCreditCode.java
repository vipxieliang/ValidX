...
import io.github.vipxieliang.validx.validator.china.UnifiedSocialCreditCodeValidator;
...
public @interface UnifiedSocialCreditCode {
    String message() default "{io.github.vipxieliang.validx.annotation.unified.social.credit.code}";
