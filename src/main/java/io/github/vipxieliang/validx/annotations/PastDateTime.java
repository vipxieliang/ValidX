...
import io.github.vipxieliang.validx.validator.base.PastDateTimeValidator;
 ...
 *
 * // 包含今天
 * {@code @PastDateTime(includeToday = true)}
 * private String loginTime;
 *
 * // 自定义格式
 * {@code @PastDateTime(pattern = "yyyy/MM/dd HH:mm:ss")}
 * private String customDateTime;
 *
 * // 带毫秒
 * {@code @PastDateTime(pattern = "yyyy-MM-dd HH:mm:ss.SSS")}
...
public @interface PastDateTime {
    ...
    /**
     * 是否包含今天
     * @return true 表示今天及之前的日期时间都有效，false 表示只有今天之前的日期时间有效
     */
     ...
     * 如只需验证日期（不含时间），请使用 @PastDate 注解。
     *
     * @return 日期时间格式模式字符串
     */
    String pattern() default "yyyy-MM-dd HH:mm:ss";

    String message() default "{io.github.vipxieliang.validx.annotation.past.datetime}";
