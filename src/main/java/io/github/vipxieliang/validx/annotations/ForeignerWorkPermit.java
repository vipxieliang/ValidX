...
@Documented
@Constraint(validatedBy = ForeignerWorkPermitValidator.class)
public @interface ForeignerWorkPermit {
    String message() default "{io.github.vipxieliang.validx.annotation.foreigner.work.permit}";
