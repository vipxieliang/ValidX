...
public class LowerValidatorTest {
    ...
    private final LowerValidator validator = new LowerValidator();
    
    @Test
    public void testValidLowerStrings() {
    ...
    @Test
    public void testInvalidLowerStrings() {
        assertFalse(validator.isValid("ABC", null)); // 大写字母
        assertFalse(validator.isValid("Abc", null)); // 首字母大写
        assertFalse(validator.isValid("aBc", null)); // 中间有大写
        assertFalse(validator.isValid("abC", null)); // 末尾大写
