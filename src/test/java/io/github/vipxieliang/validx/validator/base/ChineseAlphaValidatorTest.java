...
/**
 * ChineseAlphaValidator测试类
 */
public class ChineseAlphaValidatorTest {
    
    private final ChineseAlphaValidator validator = new ChineseAlphaValidator();
    
    @Test
    public void testValidChineseAlphaStrings() {
        ...
        assertTrue(validator.isValid("汉字ABC字母", null));
        assertTrue(validator.isValid("", null)); // 空字符串
        assertTrue(validator.isValid(null, null)); // null值
    }
    
    @Test
    public void testInvalidChineseAlphaStrings() {
        assertFalse(validator.isValid("汉字123", null)); // 包含数字
