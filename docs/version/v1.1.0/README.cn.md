...
>
> 📖 **详细迁移指南**：[MIGRATION_v1.1.0.cn.md](MIGRATION_v1.1.0.cn.md)
...
* 核心特性：
  ...
  - **灵活格式**：支持所有 Java DateTimeFormatter 格式
  - **多语言支持**：支持9种语言的错误提示
* 格式符号说明：
...
* 支持格式示例：
  ...
  - 日期时间：`yyyy-MM-dd HH:mm:ss` → `2024-01-15 13:30:00`
  - 年月：`yyyy-MM` → `2024-01`
  - 纯时间：`HH:mm:ss` → `14:30:00`
